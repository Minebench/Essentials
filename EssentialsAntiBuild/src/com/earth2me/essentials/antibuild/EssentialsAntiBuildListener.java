...
public class EssentialsAntiBuildListener implements Listener {
    ...
    private boolean metaPermCheck(final User user, final String action, final Material blockType) {
        final String blockPerm = "essentials.build." + action + "." + blockType.toString().toLowerCase(Locale.ENGLISH);
        return user.isAuthorized(blockPerm);
    }

    private boolean metaPermCheck(final User user, final String action, final Material blockType, final short data) {
        final String blockPerm = "essentials.build." + action + "." + blockType.toString().toLowerCase(Locale.ENGLISH);
    ...
    public void onPlayerInteract(final PlayerInteractEvent event) {
        ...
        if (item != null && prot.getSettingBool(AntiBuildConfig.disable_use) && !user.canBuild() && !user.isAuthorized("essentials.build")) {
